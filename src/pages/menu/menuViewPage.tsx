  ...
  return (
    <>
        ...
        <div className="box relative border-transparent bg-blue-400 bg-opacity-20 dark:bg-darkmode-600 intro-y md:w-full min-h-full">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-y-16 gap-x-16 px-12 pt-24 md:pt-12 pb-48 md:pb-12 justify-items-center">
            {/* BEGIN: Menu Content */}
        ...
        {/* BEGIN: Footer Content */}
          <div className="dark:bg-darkmode-600 w-full">
            <div className="box bg-white bg-opacity-80 border-transparent grid grid-cols-12 mt-5 p-5 my-5">
